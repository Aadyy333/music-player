...
import 'package:musicstudio/bottom_sheets/add_to_playlist.dart';
import 'package:musicstudio/bottom_sheets/get_lyrics_bottom.dart';
import 'package:musicstudio/db_funtion/functions.dart';
import 'package:musicstudio/db_model/db_model.dart';

import 'package:musicstudio/providerr/song_model_provider.dart';
...
class _MusicPlayScreenState extends State<MusicPlayScreen> {
  ...
  child: Marquee(
    ...
    style: GoogleFonts.aboreto(
      color: color1white,
      fontSize: 19 * MediaQuery.of(context).size.width / 375.0,
    ),
...
Expanded(
  child: Text(
    widget.songModel[widget.index].artist.toString() == "<unknown"
        ? " Unknown Artist"
        : widget.songModel[widget.index].artist.toString(),
    overflow: TextOverflow.ellipsis,
    style: GoogleFonts.aboreto(
      color: color1white,
      fontSize: 15 * MediaQuery.of(context).size.width / 375.0,
    ),
  ),
),
